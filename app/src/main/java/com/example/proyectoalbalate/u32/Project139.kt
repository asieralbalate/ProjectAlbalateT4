package com.example.proyectoalbalate.u32
...
import com.example.proyectoalbalate.u29.Dice2
import com.example.proyectoalbalate.u29.dataDice
...
@Composable
fun Project139(navController: NavHostController) {
    ...
    when (configuration.orientation) {
        Configuration.ORIENTATION_LANDSCAPE -> {
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Press the button to roll a dice",
                            textAlign = TextAlign.Center,
                        )
                    }
                    Row(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                FloatingActionButton(
                    onClick = { navController.navigate("FrontPageU32") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
