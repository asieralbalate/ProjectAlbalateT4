package com.example.proyectoalbalate.u23
        ...
        Configuration.ORIENTATION_LANDSCAPE -> {
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter the name and the grade of\n" +
                                    "a student to know how they\n" +
                                    "are doing.",
                            textAlign = TextAlign.Center,
                        )
                    }
                        ...
                        Button(
                            onClick = {
                                ...
                                if (!nameStudent.equals(null) && grade.toIntOrNull() != null) {
                                    val student = Student(nameStudent,grade.toInt())
                                    outcome = "${student.returnName()} are doing ${student.calculateGrades()}"
                                } else {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                FloatingActionButton(
                    onClick = { navController.navigate("Project108") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
                ...
                FloatingActionButton(
                    onClick = { navController.navigate("FrontPageU23") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
