package com.example.proyectoalbalate.u20
...
@Composable
fun Project97(navController: NavHostController) {
    ...
    when (configuration.orientation) {
        Configuration.ORIENTATION_LANDSCAPE -> {
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter five times two integers to find the largest.",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
                                ...
                                if (firstNumber.toFloatOrNull() != null && secondNumber.toFloatOrNull() != null) {
                                    if (x < 5) {
                                        ...
                                        outcome += if (firstNumber.toFloat() > secondNumber.toFloat()) {
                                            "The largest number between $firstNumber and $secondNumber is: $firstNumber"
                                        } else {
                                            "The largest number between $firstNumber and $secondNumber is: $secondNumber"
                                        }
                                    } else {
                                        outcome += if (firstNumber.toFloat() > secondNumber.toFloat()) {
                                            "The largest number between $firstNumber and $secondNumber is: $firstNumber"
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                FloatingActionButton(
                    onClick = { navController.navigate("FrontPageU20") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
