...
//Press the button to see the result of 10 dice.

@Composable
fun Project167(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Press the button to see the result of 10 dice.",
                            textAlign = TextAlign.Center,
                        )
                    }
                    Row(
                        ...
                        Button(
                            onClick = {
                                ...
                                val dice = Dice6()
                                dice.rollDice()
                                outcome += "Middle values: ${dice(4)}, ${dice(5)}\n"
                                for (i in 0..9){
                                    outcome += "${dice(i)} "
                                }
                            },
...
class Dice6() {
    ...
    operator fun invoke(nbr: Int) = array[nbr]
}