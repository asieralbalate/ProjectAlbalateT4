...
//Press the button to load three vectors with 5 elements each.

@Composable
fun Project164(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Press the button to load three vectors with 5 elements each.",
                            textAlign = TextAlign.Center,
                        )
                    }
                    Row(
                        ...
                        Button(
                            onClick = {
                                ...
                                val vec2 = vec1++
                                val vec3 = vec1--
                                outcome += "Original: ${vec1.print()}\n" +
                                        "Adding 1: ${vec2.print()}\n" +
                                        "Subtracting 1: ${vec3.print()}"
                            },
                    ...
                    Row(
                        ...
                        Button(
                            onClick = {
                                ...
                                outcome +="Original: ${vec1.print()}\n"
                                val vec2 = vec1.inc()
                                outcome += "Adding 1: ${vec2.print()}\n"
                                val vec3 = vec1.dec()
                                outcome +="Subtracting 1: ${vec3.print()}\n"
                            },
                            modifier = Modifier.padding(10.dp),
                            colors = ButtonDefaults.filledTonalButtonColors(
                                containerColor = MyGrey, contentColor = MyWhite
