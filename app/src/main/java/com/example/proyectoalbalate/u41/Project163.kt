...
//Enter a value to multiply it by the randomly created vector.

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun Project163(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter a value to multiply it by the randomly created vector.",
                            textAlign = TextAlign.Center,
                        )
                    }
                    Row(
                        ...
                        Button(
                            onClick = {
                                ...
                                if (value.toIntOrNull() != null) {
                                    ...
                                    vec1.charge()
                                    outcome += "${vec1.print()}\n"
                                    outcome += "Vector multiplied by ${value.toInt()}\n"
                                    val prod = vec1.times(value.toInt())
                                    outcome += prod.print()
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter a value to multiply it by the\n" +
