...
@Composable
fun FrontPageU34(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row {
                        Button(
                            onClick = {
                                navController.navigate("Project142")
                            },
                            ...
                            Text(text = "P142: Point")
                        }
                        Spacer(modifier = Modifier.width(15.dp))
                        Button(
                            onClick = {
                                navController.navigate("Project143")
                            },
                            modifier = Modifier.width(200.dp),
                            colors = ButtonDefaults.filledTonalButtonColors(
                                containerColor = MyGreen, contentColor = MyWhite
