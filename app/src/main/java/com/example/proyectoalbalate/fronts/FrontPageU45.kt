...
@Composable
fun FrontPageU45(navController: NavHostController) {
        ...
        Configuration.ORIENTATION_LANDSCAPE -> {
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row {
                        Button(
                            onClick = {
                                navController.navigate("Project178")
                            },
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                FloatingActionButton(
                    onClick = { navController.navigate("FrontPageU44") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
