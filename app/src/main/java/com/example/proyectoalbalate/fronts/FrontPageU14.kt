...
@Composable
fun FrontPageU14(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row {
                        Button(
                            onClick = {
                                navController.navigate("Project72")
                            },
            ...
            Box(modifier = Modifier
                ...
                Column(
                    ...
                    Row {
                        ...
                        Button(
                            onClick = {
                                navController.navigate("Project73")
                            },
                            modifier = Modifier.width(200.dp),
                            colors = ButtonDefaults.filledTonalButtonColors(
                                containerColor = MyPurple, contentColor = MyWhite
