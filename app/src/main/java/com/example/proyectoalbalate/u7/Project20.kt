package com.example.proyectoalbalate.u7
...
// Enter a number through the keyboard to determine if it is positive, negative, or zero.
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun Project20(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter a number to know if it is positive, negative or zero",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter a number to know if it is positive, \nnegative or zero",
                            textAlign = TextAlign.Center,
                        )
                    }
