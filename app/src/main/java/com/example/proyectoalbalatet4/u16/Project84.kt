...
@Composable
fun Project84(navController: NavHostController) {
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Introduce dos rectángulos para saber cual tiene el perímetro mayor",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
                        ...
                        Button(
                            onClick = {
                                if (shortSide.toFloatOrNull() != null && largeSide.toFloatOrNull() != null) {
                                    if (x < 2){
                                        left--
                                        outcome = "$left reclangle left"
                                        perimeter = ((shortSide.toFloat() * 2) + (largeSide.toFloat() * 2)).toDouble()
                                        x++
                                    } else {
                                        if (perimeter > ((shortSide.toFloat() * 2) + (largeSide.toFloat() * 2)).toDouble()){
                                            outcome = "The first rectangle is the largest"
                                        } else {
                                            outcome = "The second rectangle is the largest"
                                        }
                                        x = 1
                                        left = 2
                                    }
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                FloatingActionButton(
                    ...
                    Icon(
                        ...
                        contentDescription = null)}
                FloatingActionButton(
                    onClick = { navController.navigate("Project88") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
