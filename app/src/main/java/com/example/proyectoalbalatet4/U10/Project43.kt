...
fun Project43(navController: NavHostController) {
    ...
    var numPersons by remember { mutableStateOf(0) }
        ...
        Configuration.ORIENTATION_LANDSCAPE -> {
                        ...
                        Button(
                            onClick = {
                                if (number.toFloatOrNull() != null) {
                                    if (number.toFloat() != 0.toFloat()) {
                                        sum += number.toFloat()
                                        numPersons++
                                    } else {
                                        val average = sum / numPersons
                                        outcome = "Average: ${average.toFloat()}."
                                        numPersons = 0
                                        sum = 0.0
                                    }
                                } else {
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                FloatingActionButton(
                    onClick = { navController.navigate("Project42") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
