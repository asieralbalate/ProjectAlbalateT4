            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter base and height to know the surface of the triangle and if it is greater than 10 cm2",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
            ...
            Box(modifier = Modifier.fillMaxSize().verticalScroll(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter base and height to know the surface of\n" +
                                    "the triangle and if it is greater than 10 cm2",
                            textAlign = TextAlign.Center,
                        )
                    }
