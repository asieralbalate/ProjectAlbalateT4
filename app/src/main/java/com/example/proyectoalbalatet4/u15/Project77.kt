package com.example.proyectoalbalatet4.u15
...
fun Project77(navController: NavHostController) {
    ...
    var secondKey by remember { mutableStateOf("") }
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Enter two keys to see if they are equal",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
                        ...
                        Button(
                            onClick = {
                               if (!key.equals(null)) {
                                   if (x < 2) {
                                       secondKey = key
                                       outcome = "Repeat the key"
                                       x++
                                   } else {
                                       outcome = if(key == secondKey) {
                                    ...
                                    outcome = "Introduce a key please"
                               }
                                key = ""
                            },
