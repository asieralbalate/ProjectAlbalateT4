package com.example.proyectoalbalatet4.U4
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Introduce 3 numbers to calculate the addition and the average: ",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                FloatingActionButton(
                    ...
                    Icon(
                        ...
                        contentDescription = null)}
                FloatingActionButton(
                    onClick = { navController.navigate("Project10") },
                    modifier = Modifier
                        .padding(16.dp)
                        .size(46.dp)
            ...
            Box(Modifier.fillMaxSize()) {
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = "Introduce 3 numbers to calculate \nthe addition and the average: ",
                            textAlign = TextAlign.Center,
                        )
                    }
                    OutlinedTextField(
